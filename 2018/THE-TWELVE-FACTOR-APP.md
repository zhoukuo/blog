...
![一份代码库对应多份部署](../img/12factor/codebase-deploys.png)
...
<img src="../img/12factor/attached-resources.png" class="full" alt="一种部署附加4个后端服务" />
...
![代码被构建，然后和配置结合成为发布版本](../img/12factor/release.png)
...
![扩展表现为运行中的进程，工作多样性表现为进程类型。](../img/12factor/process-types.png)
